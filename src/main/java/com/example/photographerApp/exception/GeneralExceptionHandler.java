...
public class GeneralExceptionHandler extends ResponseEntityExceptionHandler
{
    ...
    public ResponseEntity<?> AnnouncementNotFoundExceptionHandler(AnnouncementNotFoundException exception)
    {
        return new ResponseEntity<>(exception.getMessage(), HttpStatus.NOT_FOUND);
    }

    @ExceptionHandler(AuthorityNotFoundException.class)
    public ResponseEntity<?> AuthorityNotFoundExceptionHandler(AuthorityNotFoundException exception)
    {
        return new ResponseEntity<>(exception.getMessage(), HttpStatus.NOT_FOUND);
    }
    ...
    public ResponseEntity<?> MessageNotFoundExceptionHandler(MessageNotFoundException exception)
    {
        return new ResponseEntity<>(exception.getMessage(), HttpStatus.NOT_FOUND);
    }
